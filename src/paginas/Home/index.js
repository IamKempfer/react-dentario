    ...
    return (
        <EstruturaPagina>
            ...
            <ul className="lista-sobre-aparelho limitar-container">
                <li>
                    <h3>Alinhas os dentes</h3>
                    <p>Dentes desalinhados causam problema nos dentes e podem afetar a digestão dos alimentos e a respiração.</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>Uma dentição desalinhada e com espaços significativo icomodam muito as pessoas. Usar aparelho nos dentes é uma das formas mais eficientes para que esses problemas possam ser corrigidos.</p>
                </li>
            </ul>
